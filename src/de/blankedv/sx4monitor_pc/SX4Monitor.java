...
import static de.blankedv.sx4monitor_pc.SXnetClientThread.*;
...
public class SX4Monitor extends Application {
    ...
    final String version = "v0.40 - 17 Aug 2019";
    ...
    public void start(Stage theStage) throws InterruptedException {
        ...
        //theStage.getIcons().add(new Image("/de/blankedv/sx4monitor_pc/res/sx4monitor_ico64_3.png"));
    ...
    private void createMenu(Preferences prefs, MenuBar menuBar) {
        ...
        //final ImageView ivInfo = new ImageView(new Image("file://de/blankedv/sx4monitor_pc/res/info.png"));
        ImageView ivInfo = new ImageView();
        ivInfo = new ImageView(new Image("/de/blankedv/sx4monitor_pc/res/info.png"));
    ...
    private void createButtons(HBox buttonsPane) {
        // load the images
        Image green = new Image("/de/blankedv/sx4monitor_pc/res/greendot.png");
        Image red = new Image("/de/blankedv/sx4monitor_pc/res/reddot.png");
