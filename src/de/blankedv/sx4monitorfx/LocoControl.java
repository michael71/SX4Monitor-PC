...
public class LocoControl extends Control implements MouseWheelListener {
    ...
    private final ImageView ivLeft = new ImageView(new Image("/de/blankedv/sx4monitorfx/res/left3.png", 20, 20, true, true));
    private final ImageView ivRight = new ImageView(new Image("/de/blankedv/sx4monitorfx/res/right3.png", 20, 20, true, true));

    private final ImageView ivLightOn = new ImageView(new Image("/de/blankedv/sx4monitorfx/res/lamp1.png", 20, 20, true, true));
    private final ImageView ivLightOff = new ImageView(new Image("/de/blankedv/sx4monitorfx/res/lamp0.png", 20, 20, true, true));

    private final ImageView ivFuncOn = new ImageView(new Image("/de/blankedv/sx4monitorfx/res/function1.png", 20, 20, true, true));
    private final ImageView ivFuncOff = new ImageView(new Image("/de/blankedv/sx4monitorfx/res/function0.png", 20, 20, true, true));
